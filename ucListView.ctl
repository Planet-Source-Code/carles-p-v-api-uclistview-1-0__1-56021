...
Public Property Get ColumnText(ByVal Column As Integer) As String
Attribute ColumnText.VB_MemberFlags = "400"
  ...
  Dim a(261) As Byte
    ...
    End If
End Property
Public Property Let ColumnText(ByVal Column As Integer, ByVal Text As String)
...
Public Property Get ColumnWidth(ByVal Column As Integer) As Integer
Attribute ColumnWidth.VB_MemberFlags = "400"
    ...
    End If
End Property
Public Property Let ColumnWidth(ByVal Column As Integer, ByVal Width As Integer)
...
Public Property Get ColumnAlign(ByVal Column As Integer) As eColumnAlignConstants
  ...
  Dim uLVC    As LVCOLUMN
    ...
    End If
End Property
Public Property Let ColumnAlign(ByVal Column As Integer, ByVal Align As eColumnAlignConstants)
...
Public Property Get ColumnIcon(ByVal Column As Integer) As Integer
  ...
  Dim uLVC As LVCOLUMN
    ...
    End If
End Property
Public Property Let ColumnIcon(ByVal Column As Integer, ByVal Icon As Integer)
...
Public Property Get ItemText(ByVal Item As Integer) As String
Attribute ItemText.VB_MemberFlags = "400"
  ...
  Dim lLen   As Long
    ...
    End If
End Property
Public Property Let ItemText(ByVal Item As Integer, ByVal Text As String)
...
Public Property Get ItemIcon(ByVal Item As Integer) As Integer
Attribute ItemIcon.VB_MemberFlags = "400"
  ...
  Dim uLVI As LVITEM
    ...
    End If
End Property
Public Property Let ItemIcon(ByVal Item As Integer, ByVal Icon As Integer)
...
Public Property Get ItemIndent(ByVal Item As Integer) As Integer
Attribute ItemIndent.VB_MemberFlags = "400"
  ...
  Dim uLVI As LVITEM
    ...
    End If
End Property
Public Property Let ItemIndent(ByVal Item As Integer, ByVal Indent As Integer)
...
Public Property Get ItemSelected(ByVal Item As Integer) As Boolean
Attribute ItemSelected.VB_MemberFlags = "400"
    ...
    End If
End Property
Public Property Let ItemSelected(ByVal Item As Integer, ByVal Selected As Boolean)
...
Public Property Get ItemFocused(ByVal Item As Integer) As Boolean
Attribute ItemFocused.VB_MemberFlags = "400"
    ...
    End If
End Property
Public Property Let ItemFocused(ByVal Item As Integer, ByVal Focused As Boolean)
...
Public Property Get ItemChecked(ByVal Item As Integer) As Boolean
Attribute ItemChecked.VB_MemberFlags = "400"
    ...
    End If
End Property
Public Property Let ItemChecked(ByVal Item As Integer, ByVal Checked As Boolean)
...
Public Property Get ItemGhosted(ByVal Item As Integer) As Boolean
Attribute ItemGhosted.VB_MemberFlags = "400"
    ...
    End If
End Property
Public Property Let ItemGhosted(ByVal Item As Integer, ByVal Ghosted As Boolean)
...
Public Property Get SubItemIcon(ByVal Item As Integer, ByVal SubItem As Integer) As Integer
Attribute SubItemIcon.VB_MemberFlags = "400"
  ...
  Dim uLVI As LVITEM
    ...
    End If
End Property
Public Property Let SubItemIcon(ByVal Item As Integer, ByVal SubItem As Integer, ByVal Icon As Integer)
...
Private Function pvCreate() As Boolean
  ...
  Dim lLVStyle As Long
    ...
    lLVStyle = WS_CHILD Or WS_TABSTOP Or LVS_LIST Or LVS_AUTOARRANGE Or LVS_SINGLESEL Or LVS_SHOWSELALWAYS Or LVS_SHAREIMAGELISTS
    ...
    With uNMLVCD
        ...
        Select Case .nmcd.dwDrawStage
            ...
            Case CDDS_ITEMPREPAINT Or CDDS_SUBITEM '(*)
                ...
                RaiseEvent OnSubItemPrePaint(CInt(.nmcd.dwItemSpec), CInt(.iSubItem), clrTextBk, clrText, bProcess)
                If (bProcess) Then
